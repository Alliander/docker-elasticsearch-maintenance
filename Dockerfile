...
CMD /usr/local/bin/elasticsearch-close-old-indices.sh -i 14 -e http://elasticsearch.kube-system:9200 && /usr/local/bin/elasticsearch-remove-old-indices.sh -i 25 -e http://elasticsearch.kube-system:9200
